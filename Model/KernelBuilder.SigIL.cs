...
public class SigILEmitter
{
    ...
    {
        Type simdType = VectorLevel switch
        {
    ...
    private void BuildCycleFMA()
    {
        ...
        for (int j = 0; j < NV; j++)
        {
            ...
            BuildLocalVectorB(simdSize,
                bVec, bRef, loadUnsafeWithOffset, j);
        }
    ...
    private void BuildLocalVectorB(int simdSize, Local bVec, Local bRef,
